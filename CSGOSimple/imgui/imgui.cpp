...
bool ImGui::ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    // Render
    const ImU32 col = GetColorU32((hovered && held) ? ImGuiCol_Button : hovered ? ImGuiCol_Button : ImGuiCol_Button);
    RenderNavHighlight(bb, id);
...
bool ImGui::InputTextEx(const char* label, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiTextEditCallback callback, void* user_data)
{
	...
	if (!is_multiline)
	{
		...
		window->DrawList->AddRect(frame_bb.Min, frame_bb.Max, GetColorU32(ImGuiCol_Border), 0, 15, 0.7f);
	}
...
bool ImGui::BeginCombo(const char* label, const char* preview_value, ImGuiComboFlags flags)
{
    ...
    const ImU32 frame_col = GetColorU32(hovered ? ImGuiCol_FrameBg : ImGuiCol_FrameBg);
    RenderNavHighlight(frame_bb, id);
	if (!(flags & ImGuiComboFlags_NoPreview))
	{
		window->DrawList->AddRectFilledMultiColor(frame_bb.Min, ImVec2(frame_bb.Max.x - arrow_size, frame_bb.Max.y), GetColorU32(ImVec4(0.13f, 0.13f, 0.13f, 1.f)), GetColorU32(ImVec4(0.13f, 0.13f, 0.13f, 1.f)), GetColorU32(ImVec4(0.07f, 0.07f, 0.07f, 1.f)), GetColorU32(ImVec4(0.07f, 0.07f, 0.07f, 1.f)));
		window->DrawList->AddRect(frame_bb.Min, ImVec2(frame_bb.Max.x - arrow_size, frame_bb.Max.y), GetColorU32(ImVec4(0.05f, 0.05f, 0.05f, 1.f)), 0, 15, 0.7f);
	}
    if (!(flags & ImGuiComboFlags_NoArrowButton))
    {
        window->DrawList->AddRectFilled(ImVec2(frame_bb.Max.x - arrow_size, frame_bb.Min.y), frame_bb.Max, GetColorU32((popup_open || hovered) ? ImGuiCol_Button : ImGuiCol_Button), style.FrameRounding, (w <= arrow_size) ? ImDrawCornerFlags_All : ImDrawCornerFlags_Right);
		window->DrawList->AddRect(ImVec2(frame_bb.Max.x - arrow_size, frame_bb.Min.y), frame_bb.Max, GetColorU32(ImVec4(0.05f, 0.05f, 0.05f, 1.f)), 0, 15, 0.7f);
...
bool ImGui::Combo(const char* label, int* current_item, bool (*items_getter)(void*, int, const char**), void* data, int items_count, int popup_max_height_in_items)
{
    ...
    if (!BeginCombo(label, preview_text, ImGuiComboFlags_NoArrowButton))
        return false;
...
void ImGui::Separator()
{
    ...
    window->DrawList->AddLine(bb.Min, ImVec2(bb.Max.x,bb.Min.y), GetColorU32(ImGuiCol_ButtonActive));

...
public:
	...
	bool CanFire();
	bool IsGrenade();
	bool IsKnife(CCSWeaponInfo* data);
	bool IsReloading();
	bool IsRifle(CCSWeaponInfo* data);
	bool IsPistol(CCSWeaponInfo* data);
	bool IsSniper(CCSWeaponInfo* data);
...
public:
	...
	{
		return *(HANDLE*)((uintptr_t)this + NetvarSys::Get().GetOffset("DT_BaseCombatWeapon", "m_hOwner"));
	}

	float GetC4BlowTime()
	{
		return *(float*)((uintptr_t)this + NetvarSys::Get().GetOffset("DT_PlantedC4", "m_flC4Blow"));
	}

	float GetC4DefuseCountDown()
	{
		return *(float*)((uintptr_t)this + NetvarSys::Get().GetOffset("DT_PlantedC4", "m_flDefuseCountDown"));
	}

	int GetBombDefuser()
	{
		return *(int*)((uintptr_t)this + NetvarSys::Get().GetOffset("DT_PlantedC4", "m_hBombDefuser")); 
	}

	bool IsBombDefused()
	{
		return *(bool*)((uintptr_t)this + NetvarSys::Get().GetOffset("DT_PlantedC4", "m_bBombDefused"));
	}
};
...
public:
	...
	int GetFlags()
	{
		return *(int*)((uintptr_t)this + NetvarSys::Get().GetOffset("DT_BasePlayer", "m_fFlags"));
	}
	...
	NETVAR(Vector, m_skybox3d_origin, "DT_BasePlayer", "m_skybox3d.origin");
	NETVAR(int, m_skybox3d_scale, "DT_BasePlayer", "m_skybox3d.scale");
